...
| `shell/generate-roadmap-pdf.sh` | Convert an EO's roadmap markdown variants to clean PDFs (pandoc + headless Chrome or Edge; macOS, Linux, Windows via Git Bash/WSL) | books/generate-governing-roadmap.md |
