...
#
# Required env (caller supplies — kept out of the script so it's machine-agnostic):
...
#   SYNTH_N (30)        OUTROOT (/tmp/coldrun)  RUNBOOKS_DIR (auto from this file's location)
