...
5. Write the final artifact to `/workspace/output/meeting_briefings_experiment_20260514_1221.json` and nowhere else.
...
- Write **only** to `/workspace/output/meeting_briefings_experiment_20260514_1221.json`.
...
artifact = {
    "experiment_id": "meeting_briefings_experiment_20260514_1221",
...
with open("/workspace/output/meeting_briefings_experiment_20260514_1221.json", "w") as f:
