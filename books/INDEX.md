...
| proc | top issues, district issues, distinctive issues, voter priorities, lift, baseline, state baseline, curated issues, theme cluster, haystaq lift, campaign issues, district profile | books/find-top-issues-by-district.md | Find the most distinctive campaign issues in any L2 district by lift over the state baseline (curated 106-column issue list) plus optional thematic clustering |
