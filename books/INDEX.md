...
| proc | elected official, briefing, newly elected, transition, local government, constituent data, quick wins, independent official, council, mayor, commissioner | books/generate-elected-official-briefing.md | Generate a comprehensive transition briefing for a newly elected independent official using Haystaq constituent data and local government research |
| proc | michigan, leads, enrich, voter insights, polling questions, hubspot, csv, elected officials, district, haystaq | books/enrich-michigan-leads-with-voter-insights.md | Enrich a CSV of Michigan elected officials with Haystaq constituent insights and AI-generated polling questions |
