...
| proc | meeting briefing, PMF engine, city council, briefing, serve experiment | books/run-meeting-briefing.md | Run PMF engine meeting briefings for city councils — spawns agents, tracks progress, generates PDFs |
